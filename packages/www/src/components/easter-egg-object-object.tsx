...
type EasterEggObjectObjectProps = {} & JSX.HTMLAttributes<HTMLDivElement>
...
const EasterEggObjectObjectComponent: Component<
  EasterEggObjectObjectProps
> = () => {
  ...
  return (
    <Editor class="font-light">
      ...
      <Line>
        <p class="text-white">{`at JSON.parse (<anonymous>)`}</p>
      </Line>
      <Line>
        <p class="text-white">
...
export default EasterEggObjectObjectComponent
